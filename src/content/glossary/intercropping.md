---
term: Intercropping
summary: The practice of growing two or more crop species simultaneously in the same space, either in alternating rows, mixed plantings, or with one crop understory to another. Aims to improve total yield per area and provide complementary benefits between crops.
category: growing
related_crops: [corn, beans, squash, lettuce, tomato]
related_articles: []
---
