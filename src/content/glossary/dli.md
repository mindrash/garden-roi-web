...
summary: The total amount of photosynthetically active radiation (PAR) delivered to a plant over a full day, measured in moles of photons per square meter per day (mol/m²/day). The most useful single metric for matching light conditions to crop requirements.
category: tools
related_crops: [tomato, pepper, lettuce, basil, strawberry]
related_articles: []
---
