...
hero_image: /images/crops/thai-basil.webp
description: "Thai basil delivers anise-licorice flavor no sweet basil can match. Sells for $18/lb at Asian grocers. Grow guide, variety tips, and ROI."
---
...
| Variety | Habit | Leaf | Notes |
|---|---|---|---|
| 'Siam Queen' | Compact, 18–24 in. | Large, dark green | AAS Award winner 1997; most widely available; best leaf-to-stem ratio for culinary use |
| 'Cardinal' | Upright, 24–30 in. | Medium, glossy | Prominent purple-red flower spikes; ornamental value but lower harvest yield per pinch |
| Thai market types (unselected) | Variable | Smaller, narrower | Traditional types offered by Kitazawa Seed Co.; closer to what you find at Asian grocers; less uniform but authentic flavor profile |
