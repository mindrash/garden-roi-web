...
companion_plants: [Thyme, Rosemary, Beans]
direct_sow_ok: true
indoor_weeks_needed: 0
hero_image: /images/crops/winter-savory.webp
description: "Winter savory (Satureja montana) - perennial Mediterranean herb; resinous, peppery, more intense than summer savory. $8-15/lb fresh at specialty markets. Zones 5-9. Traditional bean herb. Evergreen in mild winters."
---
...
| Characteristic | Winter Savory (*S. montana*) | Summer Savory (*S. hortensis*) |
|---|---|---|
| Lifespan | Perennial (Zones 5-9) | Annual |
| Flavor | Stronger, resinous, peppery | Milder, fresher, thyme-adjacent |
| Leaf texture | Leathery, slightly stiff | Soft, more delicate |
| Use fresh | Use sparingly - intense | Generous use is fine |
| Use dried | Excellent; holds flavor | Good |
| Harvest timing | Year-round in mild zones | Summer only |
| Propagation | Seed, cuttings, division | Seed only |
| Zone range | Perennial 5-9, annual 4 and below | Annual everywhere |
...
| Year | Plants | Approx. yield | Value @$10/lb | Annual cost | Cumulative net |
|---|---|---|---|---|---|
| 1 | 3-5 | 0.1 lb | $1.00 | $2.49 (seed) | -$1.49 |
| 2 | Same | 0.25 lb | $2.50 | $0 | $1.01 |
| 3 | Same | 0.35 lb | $3.50 | $0 | $4.51 |
| 5+ | Expanded | 0.5+ lb | $5.00+ | $0 | $9.51+ |
...
**Related crops:** [Thyme](/crops/thyme/) - closest Mediterranean herb companion; [Rosemary](/crops/rosemary/) - fellow evergreen perennial for the herb border; [Green Bean](/crops/green-bean/) - primary culinary companion for bean dishes

**Related reading:** [Herb Preservation Guide](/homestead/herb-preservation-guide/) - drying and preserving Mediterranean herbs for year-round use; [Herb ROI Comparison](/roi/herb-roi-comparison/) - comparing perennial herbs by value density and input cost over time
