...
companion_plants: [Comfrey, Fennel, Chives]
direct_sow_ok: false
indoor_weeks_needed: 0
hero_image: /images/crops/medlar.webp
description: "Medlar (Mespilus germanica) - ancient European fruit eaten only after 'bletting' (partial decomposition). $6-12/lb at specialty markets; rare in US commerce. Zones 4-8. Ornamental tree with fall harvest; flavor like spiced apple butter. Self-fertile."
---
...
**Bletting setup:**
1. Spread harvested fruits calyx-end up (blossom end up) on wooden or paper-lined trays in a single layer, not touching
2. Store in a cool (35-50°F), slightly humid location - a cool shed, unheated garage, or cool basement works well
3. Do not refrigerate below 32°F; freezing damages the cell structure differently than bletting and produces inferior results
4. Check fruits every 3-4 days beginning at week 2
...
**Related crops:** [Quince](/crops/quince/) - fellow ancient fruit requiring processing before eating; [Serviceberry](/crops/serviceberry/) - fellow underused ornamental fruit tree; [Hawthorn](/crops/hawthorn/) - related rosaceous fruiting hedgerow tree

**Related reading:** [Fruit Tree Payback Timeline](/roi/fruit-tree-payback-timeline/) - how long-lived fruit trees amortize initial investment over decades
