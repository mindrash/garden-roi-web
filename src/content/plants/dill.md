...
**Per-plant dual-harvest value breakdown:**

| Harvest type | Timing | Yield per plant | Retail value | Notes |
|---|---|---|---|---|
| Fronds (dill weed) | 40-60 days; multiple cuts | ~0.25 lb total | $1.00-2.00 ($4-8/lb) | USDA AMS fresh herb retail |
| Seed heads (pickling) | 90-110 days | 3-6 heads/plant | $1.50-3.00 ($0.50-1.00/head) | Farmers market rate, spring-summer |
| Dried seed | 110+ days | 1-3 tbsp/plant | $1.00-2.50 (bulk dried dill seed $8-15/oz) | Specialty retail; high value per ounce |
| **Total per plant** | | | **$3.50-7.50** | From a seed cost of ~$0.04/plant |

The self-sowing return in year two and beyond turns this into a zero-cost crop. A dill plant that drops seed produces the following season's volunteers with no intervention. The economic case for dill is strongest when you're matching the harvest to an actual use: fresh fronds for a summer when you cook a lot of fish and salads; heads specifically timed to a cucumber harvest for pickling.

## Succession sowing

Dill bolts in heat and has a compressed window for frond harvest - once flower buds form, the plant shifts its energy to seed production and frond quality declines. In most climates, a single spring sowing gives you fronds for 4-6 weeks before the plant wants to flower. To extend fresh frond availability through the season, sow every 2-3 weeks from last frost date through midsummer.

| Sow date (Zone 6 example) | Frond harvest window | Seed head timing | Notes |
|---|---|---|---|
| May 1 (last frost +2 weeks) | June 10-July 15 | Early August | First sowing; heads timed for early pickle season |
| May 21 | July 1-Aug 1 | Late August | Overlap with first sowing for continuous fronds |
| June 10 | July 20-Aug 20 | Mid-September | Late fronds; heads available for fall pickle run |
| July 1 | Aug 10-Sep 10 | Too late for heads | Fronds only; plant often doesn't have time to mature seed |

In year two and beyond, self-sown volunteers tend to germinate when conditions are right - typically in spring - and supplement or replace intentional succession sowings. The volunteers emerge without consistent timing, which works fine if your goal is a continuous frond supply but makes head timing for a scheduled pickle day less predictable.
...
Dill fronds and dill seed are chemically distinct and function differently in the kitchen. Fronds are dominated by phellandrene; seed by carvone and limonene. They're not interchangeable, and recipes that specify one are not asking for the other.

**Fronds (dill weed):** apply raw or add in the last 30-60 seconds of cooking. Heat destroys phellandrene rapidly - dill cooked into a sauce for 10 minutes tastes like nothing. Applications: cucumber salad (sliced cucumber + rice vinegar + sugar + salt + dill, toss and refrigerate 20 minutes); tzatziki (Greek yogurt + grated cucumber + garlic + fresh dill + olive oil - the dill is added raw); new potato salad with dill (toss warm potatoes with butter, salt, and a generous fistful of chopped fresh dill); gravlax (salt-sugar-dill cure applied to salmon fillet for 24-48 hours under refrigeration - this is a preservation application where the dill is doing more than flavor).

**Dill heads (whole heads for pickling):** the head provides both the seed and the frond chemistry together. Standard dill pickle recipe: one head per quart jar, placed at the jar bottom before packing cucumbers. The head should be in full bloom with some seeds just starting to form at the outer edges - this is the maximum flavor stage. Fresh heads can be refrigerated for 5-7 days if your pickle day doesn't line up exactly with harvest.

**Dill seed (dried):** for pickling brine, rye bread, Scandinavian fish dishes. Standard dill pickle brine uses 1 teaspoon of dried seed per quart jar if you don't have heads. Dill seed in rye bread: 1 tablespoon per loaf, added to the dough. Dill seed vinegar: steep 2 tablespoons of seed in a cup of white wine vinegar for 2 weeks, strain - the result is excellent in potato salad dressing and in Scandinavian-style salads.

---

**Related crops:** [Cucumber](/crops/cucumber/), [Lettuce](/crops/lettuce/), [Chervil](/crops/chervil/), [Lovage](/crops/lovage/)
