...
| Bean | Retail price (natural food stores) | Notes |
|---|---|---|
| Adzuki | $3-5/lb | USDA AMS; Eden Foods / Bob's Red Mill |
| Mung | $1.50-2.50/lb | USDA AMS retail survey |
| Black bean | $1-1.50/lb | USDA ERS commodity data |
| Navy bean | $1-1.25/lb | USDA ERS commodity data |
...
**Related crops:** [Edamame](/crops/edamame/), [Green Bean](/crops/green-bean/), [Fava Bean](/crops/fava-bean/)

**Related reading:** [Beginner Homestead Crops](/homestead/beginner-homestead-crops/)  -  includes legumes as soil-building, multi-return crops with storage value
