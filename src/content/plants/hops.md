...
companion_plants: [Comfrey, Yarrow, Borage]
direct_sow_ok: false
indoor_weeks_needed: 0
hero_image: /images/crops/hops.webp
...
| Category | Examples | Alpha acids | Aroma character | Primary use |
|---|---|---|---|---|
| Bittering | Magnum, Nugget, Chinook | 12-14% | Neutral, clean | Bittering additions early in boil |
| Aroma/dual | Cascade, Centennial, Willamette | 4-7% (Cascade) to 9-11% (Centennial) | Floral, citrus, pine | Late boil, dry hop |
| Noble (European) | Hallertau, Saaz, Tettnanger | 3-5% | Earthy, spicy, floral | Lager, pilsner, European ale styles |
| Specialty/experimental | Citra, Mosaic, Galaxy | 10-14% | Tropical, stone fruit | Modern IPA, craft brewing |
...
| Year | Plants | Dried yield | Value @$18/lb | Rhizome cost | Cumulative net |
|---|---|---|---|---|---|
| 1 | 1 | 0.1-0.2 lb | $1.80-3.60 | -$12.99 | -$11.19 |
| 2 | 1 | 0.5-1.0 lb | $9-18 | - | -$2.19 to $6.81 |
