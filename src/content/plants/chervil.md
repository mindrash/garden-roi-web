...
sunlight: Partial shade (3-5 hours direct sun, shade preferred)
companion_plants: [Radish, Lettuce, Carrot]
direct_sow_ok: true
indoor_weeks_needed: 0
hero_image: /images/crops/chervil.webp
description: "Chervil (Anthriscus cerefolium) - delicate cool-season herb, one of the French fines herbes. 30-45 days, $8-12/lb at specialty stores. Shade-tolerant; use it where other crops struggle."
---
...
| Characteristic | Chervil | Flat-leaf parsley | French tarragon |
|---|---|---|---|
| Flavor | Light anise, grassy, delicate | Green, vegetal, neutral | Assertive anise, vanilla |
| Heat stability | Poor; use raw or add off-heat | Good; survives cooking | Poor; use fresh or off-heat |
| Season | Cool-season annual | Biennial, tolerates heat | Perennial, dormant in winter |
| Shade tolerance | High - performs well in shade | Low - needs full sun | Low - needs full sun |
| Days to harvest | 30-45 | 70-90 | 60-90 (from division) |
| Retail availability | Rare outside specialty stores | Very common | Uncommon |
...
| Planting | Row length | Yield | Value | Seed cost | Net |
|---|---|---|---|---|---|
| Spring (succession × 3) | 4 ft × 3 = 12 ft | 0.75-1.5 lb | $7.50-15.00 | $1.87 | $5.63-13.13 |
| Fall (succession × 2) | 4 ft × 2 = 8 ft | 0.5-1.0 lb | $5.00-10.00 | $1.25 | $3.75-8.75 |
| **Annual total** | 20 ft | 1.25-2.5 lb | **$12.50-25.00** | $3.12 | **$9.38-21.88** |
...
**Related reading:** [Tarragon](/crops/tarragon/) - fellow fines herbes herb; [Herb Preservation Guide](/articles/herb-preservation-guide/) - freezing delicate herbs that don't dry well
