...
1. Remove all canes at the soil line that are 4+ years old. In practice these are easy to spot: the darkest, most gnarled wood in the shrub.
2. Remove dead, diseased, or crossing canes of any age.
3. Remove enough remaining canes to open the center of the shrub. Air should move freely through the canopy.
4. Retain 4-5 each of 1, 2, and 3-year canes.
5. The finished shrub should look open, with visible space between all major canes.
...
**Related crops:** [Currant](/crops/currant/), [Arugula](/crops/arugula/)

**Related reading:** [First Three Years ROI](/roi/first-three-years-roi/)  -  how to account for a perennial's production ramp-up in your break-even math
