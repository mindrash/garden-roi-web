...
| Variety | Cold hardiness | Habit | Notes |
|---|---|---|---|
| 'Arp' | Zone 6 (survives to -10°F with protection) | Upright, 3-4 ft | Developed at Fredericksburg, VA; strongest cold performer; slightly less pungent flavor than standard |
| 'Madelene Hill' ('Hill Hardy') | Zone 6 | Upright, 4 ft | Similar cold hardiness to 'Arp'; sourced from Texas, widely tested in the upper South |
| 'Salem' | Zone 6 borderline | Upright, 3 ft | Slightly more tender than 'Arp'; good flavor; use mulching in zone 6 winters |
| *S. rosmarinus* (standard) | Zone 7 | Upright, 4-6 ft | Most widely sold commercial form; dies reliably below about 10°F |
| 'Tuscan Blue' | Zone 8+ | Upright, 5-6 ft | Classic Italian flavor and large leaves; outstanding in warm climates, poor choice for Zone 7 and north |
| 'Prostratus' (trailing/creeping) | Zone 8+ | Ground cover, 8-12" tall | Cascades over walls and containers; flavor similar to upright forms; too tender for most of the US |

If you're in Zone 6, grow 'Arp' or 'Madelene Hill' - the standard forms from garden centers will likely die on you and will definitely die on you in a cold winter. In Zone 7+, you have full variety choice.
...
10-year value scenario for Zone 7+ (single plant, no replacement needed):

| Year | Harvest (fresh tips) | Value at $12/lb | Cumulative value | Input cost (cumulative) |
|---|---|---|---|---|
| Year 1 | 0.25 lb | $3.00 | $3.00 | $4 (transplant) |
| Year 2 | 0.40 lb | $4.80 | $7.80 | $4 |
| Year 3 | 0.60 lb | $7.20 | $15.00 | $4 |
| Year 4 | 0.75 lb | $9.00 | $24.00 | $4 |
| Year 5 | 0.75 lb | $9.00 | $33.00 | $4 |
| Years 6-10 | 0.75-1.0 lb/yr | $9.00-12.00/yr | ~$75-90 | $4 |

One established plant returns $4 investment with approximately $75-90 in herb value across a decade. In year three, the cumulative value passes your initial cost. Retail pricing from USDA AMS Specialty Crop Market News terminal reports (2023). These figures represent fresh-cut tip value; dried rosemary commands higher per-ounce prices.

## Propagation

The three practical methods for getting more rosemary plants, in order of reliability:

**Stem cuttings** are the standard approach and the fastest path to a transplant-ready plant from a parent plant you already have. Take 4-6 inch cuttings from soft new growth (not woody stems) in late spring or early summer. Remove leaves from the bottom 2 inches. Dip the cut end in rooting hormone powder (IBA, indole-3-butyric acid, sold as Rootone or equivalent). Insert into moist perlite or a 50/50 perlite and vermiculite mix. Keep moist but not wet, with indirect light, at 65-70°F. Roots develop in 3-4 weeks; cuttings are transplant-ready in 6-8 weeks. Success rate with rooting hormone: 70-80%.

**Layering** is even more reliable and requires no supplies. Bend a low-growing stem to the ground, wound the underside lightly with a knife, and bury a 4-6 inch section of the stem 2-3 inches deep while leaving the tip exposed. Pin it in place with a wire staple or small rock. Roots form along the buried section in 4-8 weeks. Sever the connection to the parent plant once rooted. Success rate: 90%+. The limitation is that it only works with plants that have flexible low branches.

**Direct from seed** is possible but not recommended for time-limited gardeners. Germination takes 14-28 days at 65-70°F soil temperature, with 30-50% germination rates typical from commercial seed. Seedlings are slow - expect 4-6 months to reach transplant size. The one advantage: you can start a large number of plants at low cost if you want 10+ rosemary plants for a hedge or large planting.

| Method | Time to transplant size | Cost | Success rate | When to use |
|---|---|---|---|---|
| Stem cutting | 6-8 weeks | Free (from parent plant) | 70-80% | Any time you have a healthy parent plant |
| Layering | 8-12 weeks (sever when rooted) | Free | 90%+ | When parent has long, flexible low stems |
| Seed | 4-6 months | $3-4/packet | 30-50% germination | When starting large numbers from scratch |
| Purchased transplant | Immediate | $3-6 each | N/A | Fastest start, no parent plant needed |
