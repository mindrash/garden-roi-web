---
title: "Vegetable Nutrient Deficiencies: Visual ID and Fix"
description: "Visual identification guide for the 6 most common nutrient deficiencies in vegetable gardens, with the mobile vs. immobile nutrient principle that determines where symptoms appear first."
category: care
publishDate: 2025-06-24
featured: false
hero_image: /images/articles/nutrient-deficiency-guide.webp
---
...
For detailed blossom end rot coverage, see the [Blossom End Rot guide](/guides/blossom-end-rot/).
...
**Related reading:** [Soil pH by Crop](/guides/soil-ph-by-crop/) - pH requirements and how to hit them; [Soil Test Decision Chain](/guides/soil-test-decision-chain/) - when to test and how to interpret results; [Soil Test ROI](/roi/soil-test-roi/) - the financial case for testing before amending
