...
**Gross return:** $205-226
**Net of inputs:** $183-204
**Seed-to-value ratio:** approximately 9:1
...
**Related guides:** [Succession Planting Calendar](/guides/succession-planting-calendar/)  -  the week-by-week timing framework that makes the planting calendar section above actionable; [The First Three Years of Garden ROI](/roi/first-three-years-roi/)  -  how planning quality compounds into better returns by Year 3; [Plan for What You Eat](/guides/plan-for-what-you-eat/) - matching the planting list to what your household actually cooks; [Garden Layout Comparison](/guides/garden-layout-comparison/) - row vs. raised bed vs. square-foot systems by space and yield; [Season Extension Tools](/guides/season-extension-tools/) - row cover, cold frames, and low tunnels to push the calendar in both directions; [Deer and Rabbit Fencing](/guides/deer-and-rabbit-fencing/) - what you need before the first seedlings go in; [Cold Frame Construction ROI](/homestead/cold-frame-construction-roi/) - build cost versus extended season value; [Hardiness Zones Explained](/guides/hardiness-zones-explained/) - how to read your zone and what it actually tells you about planting dates.
