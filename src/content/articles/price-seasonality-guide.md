...
category: roi
featured: false
hero_image: /images/articles/price-seasonality-guide.webp
...
| [Basil](/crops/basil/) | $14-18/lb | $20-28/lb | 30-55% | Freeze in oil; dry |
...
**Preservation cost:** Freezing tomatoes in gallon zip-lock bags costs roughly $0.08-0.12/lb for bags and electricity. Canning adds about $0.45-0.65 per quart for lids and energy (see the [full canning financial case](/homestead/canning-financial-case/) for the detailed breakdown). For frozen diced tomatoes, call it $0.10/lb in preservation costs.
...
For comparing how these numbers apply to specific crops in your garden, the crop pages for [tomatoes](/crops/tomato/) and [basil](/crops/basil/) break down the expected yield ranges that feed into this math. The [Freezing vs. Canning](/homestead/freezing-vs-canning/) guide covers which preservation method works best for each of the crops in the table above.
