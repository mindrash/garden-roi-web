---
title: "Soil pH by Crop: What pH Actually Controls"
description: "Soil pH determines which nutrients your plants can absorb. Here's the chemistry behind nutrient lockout and the pH ranges that matter for each crop family."
category: care
...
|---|---|---|---|
| Brassicas | [Kale](/crops/kale/), cabbage, broccoli, cauliflower | 6.0 - 7.5 | Higher end reduces clubroot |
| Nightshades | [Tomatoes](/crops/tomato/), peppers, eggplant | 6.0 - 6.8 | Below 6.0 risks manganese toxicity |
...
See also: [Companion Planting Basics](/guides/companion-planting-basics/) for how pH-appropriate beds can be designed around complementary plant groupings.
