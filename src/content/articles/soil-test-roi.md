...
featured: false
hero_image: /images/articles/soil-test-roi.webp
---
...
For a full breakdown of what a test result tells you and how to decide which amendments to buy, see [Soil Test to First Harvest: The Decision Chain](/guides/soil-test-decision-chain/). The decision chain article walks through each nutrient metric, the ideal ranges, and the amendment costs for each deficiency.
...
For context on how soil prep fits into the broader cost structure of a new vegetable garden, see [raised bed break-even math](/roi/raised-bed-break-even/) - the soil fill and first-year amendment costs there assume pH-corrected, properly prepared soil as a baseline.
