---
title: "Organic vs. Conventional: The Home Grower's Break-Even"
description: "USDA ERS organic price premium data shows which crops give organic buyers the highest return on growing their own. The break-even math for organic households."
category: roi
featured: false
hero_image: /images/articles/organic-produce-cost-analysis.webp
...
| Crop | Conventional retail ($/lb) | Organic retail ($/lb) | Organic premium ($/lb and %) | Home-grown input cost ($/lb) |
|---|---|---|---|---|
...
[Strawberry](/crops/strawberry/) and [basil](/crops/basil/) pages have detailed growing information. For the full picture on what a new garden returns in Year 1 versus steady state, see [First Three Years of Garden ROI](/roi/first-three-years-roi/).
