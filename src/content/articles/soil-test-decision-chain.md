---
title: "Soil Test to First Harvest: The Decision Chain"
description: "How to read a soil test and decide what to do before you plant. Interpretation table for pH, N-P-K, calcium, magnesium, CEC, and organic matter, with amendment costs and yield penalties for skipping corrections."
category: planning
...
**If pH is below 5.5:**
Apply agricultural lime. The rate depends on your soil type (clay vs. sandy loam vs. sandy) because CEC affects how much buffering capacity the soil has. Penn State Extension rates for a 6-inch-deep bed:
...
**If pH is above 7.5:**
Apply elemental sulfur. Rate: 1 to 2 lb per 100 sq ft for sandy soil, up to 3 lb per 100 sq ft for clay soil, to drop pH by approximately 0.5 units (Ohio State University Extension, *Adjusting Soil pH*). Sulfur oxidizes slowly - give it 2 to 3 months. A 5 lb bag costs $8 to $12.
...
1. Test. Send samples 6 to 8 weeks before planting date to allow time for corrections to take effect.
2. Address pH first. Apply lime or sulfur at the rate your extension lab recommends and incorporate into the top 6 inches.
3. Address macronutrients. Phosphorus and potassium deficiencies can be corrected within 2 to 4 weeks of incorporation.
4. Address Ca and Mg if deficient. Gypite and Epsom salt act within days to weeks.
5. Add compost for OM improvement, but understand this is a multi-season investment, not an immediate fix.
6. Re-test every 2 to 3 years. Soil chemistry changes with cropping and inputs.

For the specific pH preferences of individual crops, see [Soil pH by Crop](/guides/soil-ph-by-crop/). For how soil quality affects long-term yield and ROI, see the [tomato growing guide](/crops/tomato/) and the [kale growing guide](/crops/kale/), which both cover soil prep requirements in detail.
